...
| **Evaluation Benchmark**       | PASS   | `tsx scripts/run-eval.ts`    | 24 multi-country scenario evals (100% passing in 7ms)          |
...
- **GDPR Anonymization:** Scrubs personal contact information across active sessions and historical quote tables while preserving cryptographic audit validity.
...
1. **Synthetic Insurer:** Northstar Home Insurance EU is a synthetic reference model for demonstration and educational purposes.
2. **Non-Binding Quotes:** Quotations generated by this system are non-binding estimates and do not execute financial payment or underwrite binding policies.
3. **Illustrative Actuarial Tables:** Actuarial coefficients and tax rates are demonstration values and should be replaced with production actuarial engines in production deployments.

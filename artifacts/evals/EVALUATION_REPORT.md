...
| **SCN-010** | State Correction Invalidation Loop | `STATE_CORRECTION` | ✅ PASS | Active quote invalidated, step reverted to COLLECTING_PROPERTY, correction count incremented | Active quote: undefined, Step: COLLECTING_PROPERTY, Corrections: 1 | 2ms |
| **SCN-011** | Dynamic Deductible Adjustment | `STATE_CORRECTION` | ✅ PASS | Reduced total premium reflecting €1000 deductible discount | €61.36 (down from €161.66) | 0ms |

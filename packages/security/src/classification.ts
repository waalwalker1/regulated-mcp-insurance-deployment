export type DataClassificationTier = 'PUBLIC' | 'INTERNAL' | 'CONFIDENTIAL' | 'RESTRICTED_PII';
...
export const DATA_CLASSIFICATION_REGISTRY: Record<string, FieldDataClassification> = {
  country: {
    fieldName: 'country',
    tier: 'INTERNAL',
    justification: 'Required for underwriting jurisdiction and regional pricing calculation.',
  ...
  contactEmail: {
    ...
    tier: 'RESTRICTED_PII',
    justification: 'Contact address for non-binding quote PDF delivery. Processed only after consent.',
    retentionPeriod: 'Purged immediately upon session completion or 30-day expiry',
    redactedInLogs: true
  },

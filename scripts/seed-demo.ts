...
async function seedDemoData() {
  console.log(
    "==> Seeding synthetic demonstration sessions into active store...",
  );
  ...
  await engine.selectCoverage(s1.sessionId, {
  ...
  console.log(
    `  -> Seeded Session 1 (FR Apartment, Quoted €${q1.pricing.totalAnnualPremium}): ${s1.sessionId}`,
  );
